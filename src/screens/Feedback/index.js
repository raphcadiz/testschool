          ...
          <View style={styles.bg}>
            <View style={styles.contentIconsContainer}>
              <Button transparent style={styles.roundedButton}>
                <IconI
                  name="ios-call"
                  style={{ fontSize: 30,marginLeft:10, width: 30, color: "#FFF" }}
                />
              </Button>
              ...
              <Button transparent style={styles.roundedButton}>
                <IconI
                  name="ios-pin"
                  style={{ fontSize: 28, marginLeft:13,width: 30, color: "#FFF" }}
                />
              </Button>
            </View>
          ...
          <View style={styles.feedbackContainer}>
            <Item rounded style={styles.inputGrp}>
              <IconI
                name="ios-mail"
                size={30}
                style={{ color: "rgba(0,0,0,0.5)", marginTop: 3,marginLeft:10 }}
              />
              <Input
                placeholder="Email"
