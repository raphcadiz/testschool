        ...
        <Content showsVerticalScrollIndicator={false}>
          ...
          <View>
            ...
            <View style={styles.contentContainer}>
              <Grid>
                <Col style={{ flexDirection: "row" }}>
                  <IconI name="ios-chatboxes" style={styles.timelineIcon} />
          ...
          <View>
            ...
            <View style={styles.contentContainer}>
              <Grid>
                <Col style={{ flexDirection: "row" }}>
                  <IconI name="ios-download" style={styles.timelineIcon} />
          ...
          <View>
            ...
            <View style={styles.contentContainer}>
              <Grid>
                <Col style={{ flexDirection: "row" }}>
                  <IconI name="ios-thumbs-up" style={styles.timelineIcon} />
                  <View style={{ paddingLeft: 10 }}>
          ...
          <View>
            ...
            <View style={styles.contentContainer}>
              <Grid>
                <Col style={{ flexDirection: "row" }}>
                  <IconI name="ios-copy" style={styles.timelineIcon} />
                  <View style={{ paddingLeft: 13 }}>
          ...
          <View>
            ...
            <View style={styles.contentContainer}>
              <Grid>
                <Col style={{ flexDirection: "row" }}>
                  <IconI name="ios-archive" style={styles.timelineIcon} />
                  <View style={{ paddingLeft: 13 }}>
